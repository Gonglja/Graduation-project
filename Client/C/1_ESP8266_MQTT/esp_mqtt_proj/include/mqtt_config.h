...
#define MQTT_HOST            "139.199.59.172" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
#define MQTT_PORT            1883    // the listening port of your MQTT server or MQTT broker
#define MQTT_CLIENT_ID        "esp_0001"    // the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
#define MQTT_USER            "admin_esp" // your MQTT login name, if MQTT server allow anonymous login,any string is OK, otherwise, please input valid login name which you had registered
#define MQTT_PASS            "0800" // you MQTT login password, same as above
#define STA_SSID "PandoraBox_010203"    // your AP/router SSID to config your device networking
#define STA_PASS "18253445416a" // your AP/router password
